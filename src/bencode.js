...
var util_1 = createCommonjsModule(function(module) {
  ...
  util.digitCount = function digitCount2(value) {
    const sign = value < 0 ? 1 : 0;
    value = Math.abs(Number(value || 1));
    return Math.floor(Math.log10(value)) + 1 + sign;
  };
  util.getType = function getType2(value) {
...
var decode_1 = decode;
const {digitCount, getType: getType$1} = util_1;
...
var byteLength$1 = lib.byteLength;
var decode$1 = lib.decode;
export default lib;
var encode$1 = lib.encode;
var encodingLength$1 = lib.encodingLength;
export {lib as __moduleExports, byteLength$1 as byteLength, decode$1 as decode, encode$1 as encode, encodingLength$1 as encodingLength};
